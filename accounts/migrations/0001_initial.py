    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_budget', models.DecimalField(decimal_places=0, default=0, help_text="Oylik byudjet (so'm)", max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['code', 'is_used'], name='accounts_ve_code_3bd3de_idx'), models.Index(fields=['telegram_id', 'expires_at'], name='accounts_ve_telegra_075d76_idx')],
            },
        ),
    ]
